...
class CTkCanvas(tkinter.Canvas):
    ...
    def init_font_character_mapping(cls) -> None:
        radius_to_char_fine_windows_10: dict[int, str] = {
            19: "A", 18: "A", 17: "B", 16: "B", 15: "B", 14: "B", 13: "C", 12: "C", 11: "C", 10: "C",
             9: "D",  8: "D",  7: "D",  6: "C",  5: "D",  4: "G",  3: "G",  2: "H",  1: "H",  0: "A"}

        radius_to_char_fine_windows_11: dict[int, str] = {
            19: "A", 18: "A", 17: "B", 16: "B", 15: "B", 14: "B", 13: "C", 12: "C", 11: "D", 10: "D",
             9: "E",  8: "F",  7: "C",  6: "I",  5: "E",  4: "G",  3: "P",  2: "R",  1: "R",  0: "A"}

        radius_to_char_fine_linux: dict[int, str] = {
            19: "A", 18: "A", 17: "B", 16: "B", 15: "B", 14: "B", 13: "F", 12: "C", 11: "F", 10: "C",
             9: "D",  8: "G",  7: "D",  6: "F",  5: "D",  4: "G",  3: "M",  2: "H",  1: "H",  0: "A"}
    ...
    def coords(self, tag_or_id: str | int, *args: Any) -> list[float] | None:
